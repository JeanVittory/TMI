        ...
        <>
           {!productsAdded.length?(
            <div className="container mx-auto mt-8 mb-36">
                ...
                <button className='border border-black p-2 mt-4 bg-black text-white font-Mono letter tracking-widest' onClick={handleNavigate}>Take me back at store</button>
            </div>
           ) :(
                        ...
                        <section className="grid md:grid-cols-3">
                            ...
                            {productsAdded.map( e => <Cart key= {e.id} id= {e.id} name = {e.name} picture ={e.picture} price={e.price} quantity = {e.quantity} size = {e.size}/> )}
                            ...
                            <div className="grid  grid-cols-2  md:col-span-3  md:justify-self-end  md:grid  md:grid-cols-2  my-4  gap-x-4 md:gap-4">        
                                ...
                                <p className="font-Mono my-4">{subTotal().toFixed(2)}</p>
